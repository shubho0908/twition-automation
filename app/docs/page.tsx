...
export default function DocsPage() {
      ...
      <Card className="min-h-screen rounded-none border-none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 sm:gap-8">
          <div className="lg:col-span-1 order-2 lg:order-1">
            <Card>
              <CardHeader className="px-4 sm:px-6">
                <CardTitle className="text-base sm:text-lg font-medium">Quick Navigation</CardTitle>
              </CardHeader>
          ...
          <div className="lg:col-span-3 space-y-6 sm:space-y-8 order-1 lg:order-2">
            ...
            <Card id="overview">
              <CardHeader className="px-4 sm:px-6">
                <CardTitle className="text-xl sm:text-2xl font-bold">What does this do?</CardTitle>
              ...
              <CardContent className="space-y-4 sm:space-y-6 px-4 sm:px-6">
                <Card className="bg-muted">
                  <CardHeader className="px-4 sm:px-6">
                    <CardTitle className="text-base sm:text-lg font-semibold">How it works</CardTitle>
                  </CardHeader>
                  <CardContent className="px-4 sm:px-6">
                    <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0 sm:space-x-6">
                      <Card className="text-center p-3 sm:p-4 w-full sm:w-auto">
                        <CardContent className="p-0">
                          <Badge variant="outline" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full mb-2 bg-blue-100 dark:bg-blue-900 border-blue-300">
                            <span className="text-blue-600 dark:text-blue-400 font-medium text-sm sm:text-base">1</span>
                          </Badge>
                          <p className="text-xs sm:text-sm">Read Notion</p>
                        </CardContent>
                      </Card>
                      <Separator className="hidden sm:flex flex-1" />
                      <Card className="text-center p-3 sm:p-4 w-full sm:w-auto">
                        <CardContent className="p-0">
                          <Badge variant="outline" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full mb-2 bg-green-100 dark:bg-green-900 border-green-300">
                            <span className="text-green-600 dark:text-green-400 font-medium text-sm sm:text-base">2</span>
                          </Badge>
                          <p className="text-xs sm:text-sm">Generate Content</p>
                        </CardContent>
                      </Card>
                      <Separator className="hidden sm:flex flex-1" />
                      <Card className="text-center p-3 sm:p-4 w-full sm:w-auto">
                        <CardContent className="p-0">
                          <Badge variant="outline" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full mb-2 bg-purple-100 dark:bg-purple-900 border-purple-300">
                            <span className="text-purple-600 dark:text-purple-400 font-medium text-sm sm:text-base">3</span>
                          </Badge>
                          <p className="text-xs sm:text-sm">Post to Twitter</p>
                        </CardContent>
                      </Card>
                    </div>
                  </CardContent>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                  <Card className="text-center">
                    <CardContent className="pt-4 sm:pt-6 px-3 sm:px-6">
                      ...
                      <div className="text-xs sm:text-sm font-medium">Endpoints</div>
                  ...
                  <Card className="text-center">
                    <CardContent className="pt-4 sm:pt-6 px-3 sm:px-6">
                      ...
                      <div className="text-xs sm:text-sm font-medium">Reliability</div>
            ...
            <Card id="authentication">
              <CardHeader className="px-4 sm:px-6">
                <CardTitle className="text-xl sm:text-2xl font-bold">Setup</CardTitle>
              ...
              <CardContent className="space-y-3 sm:space-y-4 px-4 sm:px-6">
                <div className="space-y-3">
                  <CardTitle className="font-medium text-base sm:text-lg">You need these API keys:</CardTitle>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <Card>
                      <CardHeader className="pb-2">
                        <CardTitle className="font-medium text-sm sm:text-base">Notion API Key</CardTitle>
                        <CardDescription className="font-medium text-xs sm:text-sm">Get from developers.notion.com</CardDescription>
                      </CardHeader>
                    </Card>
                    <Card>
                      <CardHeader className="pb-2">
                        <CardTitle className="font-medium text-sm sm:text-base">Twitter API Keys</CardTitle>
                        <CardDescription className="font-medium text-xs sm:text-sm">Get from developer.twitter.com</CardDescription>
                      </CardHeader>
                    </Card>
                    <Card>
                      <CardHeader className="pb-2">
                        <CardTitle className="font-medium text-sm sm:text-base">Gemini AI Key</CardTitle>
                        <CardDescription className="font-medium text-xs sm:text-sm">Get from ai.google.dev</CardDescription>
                      </CardHeader>
                    </Card>
                    <Card>
                      <CardHeader className="pb-2">
                        <CardTitle className="font-medium text-sm sm:text-base">Email Settings</CardTitle>
                        <CardDescription className="font-medium text-xs sm:text-sm">For notifications</CardDescription>
                      </CardHeader>
                    </Card>
                  </div>
                </div>
            ...
            <Card id="endpoints">
              <CardHeader className="px-4 sm:px-6">
                <CardTitle className="text-xl sm:text-2xl font-bold">API Endpoints</CardTitle>
                <CardDescription className="text-sm sm:text-base">Just two simple endpoints</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4 sm:space-y-6 px-4 sm:px-6">
              ...
              <Card id="post-automate">
                <CardHeader className="px-4 sm:px-6">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <Badge variant="default" className="bg-green-100 text-green-800 hover:bg-green-100 text-xs sm:text-sm">
                      POST
                    </Badge>
                    <CardTitle className="text-base sm:text-lg font-medium">/api/automate</CardTitle>
                  </div>
                ...
                <CardContent className="space-y-3 sm:space-y-4 px-4 sm:px-6">
                  <div>
                    ...
                    <div className="space-y-3">
                      <div>
                        <div className="text-sm text-green-400 mb-1 font-mono"># Basic automation</div>
                        <CodeBlock copyText={`curl -X POST ${baseUrl}/api/automate`}>
                          <span className="text-white">curl -X POST {baseUrl}/api/automate</span>
                        </CodeBlock>
                      </div>
                      <div>
                        <div className="text-sm text-green-400 mb-1 font-mono"># With specific Notion page</div>
                        <CodeBlock copyText={`curl -X POST "${baseUrl}/api/automate?pageId=your-page-id"`}>
                          <span className="text-white">curl -X POST &quot;{baseUrl}/api/automate?pageId=your-page-id&quot;</span>
                        </CodeBlock>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Card className="bg-slate-900 border-slate-700 overflow-hidden">
                      <CardContent className="p-0">
                        <pre className="text-green-400 text-sm font-mono overflow-x-auto p-4">{`{
  "success": true,
  ...
  "metadata": {
    ...
    "version": "1.0.0"
                  ...
                  <div>
                    ...
                    <Card className="bg-slate-900 border-slate-700 overflow-hidden">
                      <CardContent className="p-0">
                        <pre className="text-yellow-400 text-sm font-mono overflow-x-auto p-4">{`{
  "success": true,
  ...
  "tasks": []
                  ...
                  <div>
                    ...
                    <Card className="bg-slate-900 border-slate-700 overflow-hidden">
                      <CardContent className="p-0">
                        <pre className="text-red-400 text-sm font-mono overflow-x-auto p-4">{`{
  "success": false,
  ...
  "debug": {
    ...
    "stage": "twitter-posting"
              ...
              <Card id="get-automate">
                <CardHeader className="px-4 sm:px-6">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <Badge variant="secondary" className="bg-blue-100 text-blue-800 hover:bg-blue-100 text-xs sm:text-sm">
                      GET
                    </Badge>
                    <CardTitle className="text-base sm:text-lg font-medium">/api/automate</CardTitle>
                  </div>
                ...
                <CardContent className="space-y-3 sm:space-y-4 px-4 sm:px-6">
                  <div>
                    ...
                    <CodeBlock copyText={`curl ${baseUrl}/api/automate`}>
                      <span className="text-green-400">curl {baseUrl}/api/automate</span>
                    </CodeBlock>
                  </div>
              ...
              <Card id="get-status">
                <CardHeader className="px-4 sm:px-6">
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <CardTitle className="text-base sm:text-lg font-medium">/api/status</CardTitle>
                  </div>
                  <CardDescription className="font-medium text-xs sm:text-sm">
                ...
                <CardContent className="space-y-3 sm:space-y-4 px-4 sm:px-6">
                  <div>
                    <h4 className="text-sm font-medium mb-2">Request</h4>
                    <CodeBlock copyText={`curl ${baseUrl}/api/status?detailed=true`}>
                      <span className="text-green-400">curl {baseUrl}/api/status?detailed=true</span>
                    </CodeBlock>
                  </div>
  ...
  "overall": {
    ...
    "message": "All systems operational with enhanced error handling"
            ...
            <Card id="examples">
              <CardHeader className="px-4 sm:px-6">
                <CardTitle className="text-xl sm:text-2xl font-bold">Ways to use it</CardTitle>
                <CardDescription className="text-sm sm:text-base">Pick what works best for you</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4 sm:space-y-6 px-4 sm:px-6">
                <div>
                  <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">🔘 Notion Button (Easiest)</h3>
                  <Card className="bg-muted">
                    <CardContent className="px-3 sm:px-6">
                      <p className="text-xs sm:text-sm text-muted-foreground mb-2">Add a button to your Notion page:</p>
                      <ul className="text-xs sm:text-sm space-y-1">
                        <li>1. Type <code className="bg-background px-1 rounded">/button</code> in Notion</li>
                        <li>2. Set URL to: <code className="bg-background px-1 rounded text-xs">{baseUrl}/api/automate?pageId=62821820-ea75-4dca-b0e6-f1bb857c58a2</code></li>
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">📱 JavaScript/Fetch</h3>
                  <CodeBlock copyText={`fetch('/api/automate', {
  method: 'POST'
})
.then(response => response.json())
.then(data => console.log(data))
.catch(error => console.error('Error:', error));`}>
                    <span className="text-green-400">{`fetch('/api/automate', {
  method: 'POST'
})
.then(response => response.json())
.then(data => console.log(data))
.catch(error => console.error('Error:', error));`}</span>
                  </CodeBlock>
                </div>

                <div>
                  <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">🔗 Command Line</h3>
                  <CodeBlock copyText={`curl -X POST ${baseUrl}/api/automate`}>
                    <span className="text-green-400">curl -X POST {baseUrl}/api/automate</span>
                  </CodeBlock>
                </div>
              </CardContent>
            </Card>
            ...
            <Card id="errors">
              <CardHeader className="px-4 sm:px-6">
                <CardTitle className="text-xl sm:text-2xl font-bold">When things go wrong</CardTitle>
                <CardDescription className="text-sm sm:text-base">Common error messages and what they mean</CardDescription>
              </CardHeader>
